package com.example.latend_menu
...
// build.gradle 에서 메뉴 바 설정을 위해 깔아야
// res 에 menu 폴더 만들기
// menu navi_menu 만들기
// 아이콘 drawable 에 추가

class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener { // 이 부분 메뉴바 잊지 말자
    ...
    private fun gotoUpdatePage() {
        val intent = Intent(this, UpdateInfo::class.java) // 다음 화면으로 이동하기 위한 Intent 객체 생성
    ...
    private fun gotoFoodPate() {
        val intent = Intent(this, DevFood::class.java) // 다음 화면으로 이동하기 위한 Intent 객체 생성
        startActivity(intent) // intent에 저장되어있는 activity로 이동한다.
    }

    private fun gotoAddSuggest() {
        val intent = Intent(this, AdSuggest::class.java) // 다음 화면으로 이동하기 위한 Intent 객체 생성
        startActivity(intent) // intent에 저장되어있는 activity로 이동한다.
    }
    ...
    private fun gotoHelp() {
        val intent = Intent(this, Help::class.java) // 다음 화면으로 이동하기 위한 Intent 객체 생성
        startActivity(intent) // intent에 저장되어있는 activity로 이동한다.
    }
